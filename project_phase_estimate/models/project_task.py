...
class Task(models.Model):
    ...
    estimate_id = fields.Many2one(
        "project.estimate", string="Project Estimate", compute="_compute_estimate_id"
    )
    estimate_progress = fields.Float(
        related="estimate_id.progress", string="Estimate Progress"
    )
